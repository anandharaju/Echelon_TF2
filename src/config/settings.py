...
EPOCHS = 50  #50
EARLY_STOPPING_PATIENCE_TIER1 = 3  # 5
EARLY_STOPPING_PATIENCE_TIER2 = 1  # 5
...
DATASET_BACKUP_FILE = PKL_SOURCE_PATH + ESC + 'Raw_To_Pickle.csv'
...
PERCENTILES = [50, 75, 90]  # [0, 25, 50, 75, 80, 85, 88, 90, 91, 92, 94, 95, 96]
