...
DATASET_BACKUP_FILE = 'D:\\08_Dataset\\Sorel\\def_file_stats.csv'
Error_Files = 'D:\\08_Dataset\\Sorel\\erroneous_files.csv'
RAW_SAMPLE_DIRS = {
    'F:\\Sorel\\def': False              # Malware-False
}
...
def get_statistics(path, is_benign, unprocessed, processed):
    ...
    for src_dir, dirs, files in os.walk(path):
        for file_ in files:
            if file_ <= "d9cd4e5e857de885132b092632d3e25e8f4748715ff3e8707d23b1b98d601486":
                processed += 1
                continue
            try:
